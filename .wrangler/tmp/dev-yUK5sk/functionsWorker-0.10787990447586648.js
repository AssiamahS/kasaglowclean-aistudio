...
// .wrangler/tmp/bundle-emuyZP/checked-fetch.js
...
// .wrangler/tmp/pages-9J2C44/functionsWorker-0.10787990447586648.mjs
...
var init_checked_fetch = __esm({
  "../.wrangler/tmp/bundle-RLlUkT/checked-fetch.js"() {
...
async function onRequestPost({ request, env }) {
  try {
    ...
    const {
      ...
      balanceDue,
      tier
      // optional: "New" | "Returning" | "VIP" | "Paused"
    } = body;
...
var init_create = __esm({
  "api/clients/create.ts"() {
    init_functionsRoutes_0_7351149683889399();
    init_checked_fetch();
...
var init_update_tier = __esm({
  "api/clients/update-tier.ts"() {
    init_functionsRoutes_0_7351149683889399();
    init_checked_fetch();
...
async function onRequestGet2({ env }) {
  try {
    ...
    const clients = (result.results || []).map((sub) => ({
      id: sub.id,
      name: sub.name,
      email: sub.email,
      phone: sub.phone,
...
var init_fix_job_locations = __esm({
  "api/fix-job-locations.ts"() {
    init_functionsRoutes_0_7351149683889399();
    init_checked_fetch();
...
__name(cleanExpiredLogs, "cleanExpiredLogs");
...
async function onRequestDelete3() {
  logs = [];
...
var init_log = __esm({
  "api/log.ts"() {
    ...
    logs = [];
    MAX_LOGS = 1e3;
    LOG_EXPIRY_MS = 60 * 60 * 1e3;
    __name2(cleanExpiredLogs, "cleanExpiredLogs");
...
var init_migrate_appointments = __esm({
  "api/migrate-appointments.ts"() {
    init_functionsRoutes_0_7351149683889399();
    init_checked_fetch();
...
var onRequestPost7;
var init_paypal_capture = __esm({
  "payments/paypal-capture.ts"() {
    init_functionsRoutes_0_7351149683889399();
    init_checked_fetch();
...
var onRequestPost8;
var init_paypal_order = __esm({
  "payments/paypal-order.ts"() {
    init_functionsRoutes_0_7351149683889399();
    init_checked_fetch();
    onRequestPost8 = /* @__PURE__ */ __name2(async ({ env }) => {
      const auth = Buffer.from(env.PAYPAL_CLIENT_ID + ":" + env.PAYPAL_SECRET).toString("base64");
...
var init_stripe_checkout = __esm({
  "payments/stripe-checkout.ts"() {
    ...
    onRequestPost9 = /* @__PURE__ */ __name2(async ({ env }) => {
...
var routes;
var init_functionsRoutes_0_7351149683889399 = __esm({
  "../.wrangler/tmp/pages-9J2C44/functionsRoutes-0.7351149683889399.mjs"() {
    init_create();
    init_update_tier();
    init_appointments();
    init_appointments();
...
// .wrangler/tmp/bundle-emuyZP/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-emuyZP/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.10787990447586648.js.map
