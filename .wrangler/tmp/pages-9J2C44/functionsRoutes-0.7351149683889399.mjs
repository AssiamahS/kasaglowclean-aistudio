...
import { onRequestDelete as __api_appointments_index_ts_onRequestDelete } from "/Users/djsly/.claude-worktrees/kasaglowclean-aistudio/hungry-visvesvaraya/functions/api/appointments/index.ts"
import { onRequestGet as __api_appointments_index_ts_onRequestGet } from "/Users/djsly/.claude-worktrees/kasaglowclean-aistudio/hungry-visvesvaraya/functions/api/appointments/index.ts"
import { onRequestPost as __api_appointments_index_ts_onRequestPost } from "/Users/djsly/.claude-worktrees/kasaglowclean-aistudio/hungry-visvesvaraya/functions/api/appointments/index.ts"
import { onRequestPut as __api_appointments_index_ts_onRequestPut } from "/Users/djsly/.claude-worktrees/kasaglowclean-aistudio/hungry-visvesvaraya/functions/api/appointments/index.ts"
...
import { onRequestPut as __api_clients_index_ts_onRequestPut } from "/Users/djsly/.claude-worktrees/kasaglowclean-aistudio/hungry-visvesvaraya/functions/api/clients/index.ts"
import { onRequestGet as __api_fix_job_locations_ts_onRequestGet } from "/Users/djsly/.claude-worktrees/kasaglowclean-aistudio/hungry-visvesvaraya/functions/api/fix-job-locations.ts"
...
import { onRequestGet as __api_migrate_appointments_ts_onRequestGet } from "/Users/djsly/.claude-worktrees/kasaglowclean-aistudio/hungry-visvesvaraya/functions/api/migrate-appointments.ts"
...
export const routes = [
    ...
    },
  {
      ...
      method: "DELETE",
      middlewares: [],
      modules: [__api_appointments_index_ts_onRequestDelete],
    },
  {
      routePath: "/api/appointments",
      mountPath: "/api/appointments",
      method: "GET",
      middlewares: [],
      modules: [__api_appointments_index_ts_onRequestGet],
    },
  {
      routePath: "/api/appointments",
      mountPath: "/api/appointments",
      method: "POST",
      middlewares: [],
      modules: [__api_appointments_index_ts_onRequestPost],
    },
  {
      routePath: "/api/appointments",
      mountPath: "/api/appointments",
      method: "PUT",
      middlewares: [],
      modules: [__api_appointments_index_ts_onRequestPut],
    },
  {
    ...
    },
  {
      ...
      method: "PUT",
      middlewares: [],
      modules: [__api_clients_index_ts_onRequestPut],
    },
  {
      routePath: "/api/fix-job-locations",
      mountPath: "/api",
      method: "GET",
      middlewares: [],
      modules: [__api_fix_job_locations_ts_onRequestGet],
    },
  {
      routePath: "/api/jobs",
      mountPath: "/api",
  ...
  {
      routePath: "/api/migrate-appointments",
      mountPath: "/api",
      method: "GET",
      middlewares: [],
      modules: [__api_migrate_appointments_ts_onRequestGet],
    },
  {
