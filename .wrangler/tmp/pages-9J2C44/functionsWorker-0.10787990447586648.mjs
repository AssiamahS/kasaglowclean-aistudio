...
var logs, MAX_LOGS, LOG_EXPIRY_MS;
var init_log = __esm({
  "api/log.ts"() {
    init_functionsRoutes_0_7351149683889399();
    init_checked_fetch();
...
var init_paypal_order = __esm({
  "payments/paypal-order.ts"() {
    init_functionsRoutes_0_7351149683889399();
    init_checked_fetch();
    onRequestPost8 = /* @__PURE__ */ __name(async ({ env }) => {
      const auth = Buffer.from(env.PAYPAL_CLIENT_ID + ":" + env.PAYPAL_SECRET).toString("base64");
...
var init_stripe_checkout = __esm({
  "payments/stripe-checkout.ts"() {
    ...
    onRequestPost9 = /* @__PURE__ */ __name(async ({ env }) => {
...
// ../.wrangler/tmp/bundle-RLlUkT/middleware-loader.entry.ts
init_functionsRoutes_0_7351149683889399();
init_checked_fetch();

// ../.wrangler/tmp/bundle-RLlUkT/middleware-insertion-facade.js
init_functionsRoutes_0_7351149683889399();
init_checked_fetch();
...
//# sourceMappingURL=functionsWorker-0.10787990447586648.mjs.map
